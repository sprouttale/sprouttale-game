...
export const Minimap: React.FC<MinimapProps> = ({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const activeWorldW = (myMap === "world_4" || myMap === "world_5" || myMap === "world_6" || myMap === "world_7") ? 1500 : (myMap === "world_1" ? 1500 : 2000);
      const activeWorldH = (myMap === "world_4" || myMap === "world_5" || myMap === "world_6" || myMap === "world_7") ? 1500 : (myMap === "world_1" ? 2500 : 2000);
